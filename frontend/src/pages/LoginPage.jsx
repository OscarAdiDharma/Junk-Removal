    ...
    <div className="auth-page">
      <div className="card auth-card">
        ...
        <div style={{ marginTop: '16px', padding: '14px', background: 'var(--primary-xlight)', borderRadius: '10px', border: '1px solid var(--border)' }}>
          <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '8px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Demo Akun</p>
          <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '3px' }}>👤 Customer: budi@gmail.com / password123</p>
          <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>🔧 Admin: admin@angkutcepat.id / admin123</p>
        </div>
      </div>
    </div>
  );
